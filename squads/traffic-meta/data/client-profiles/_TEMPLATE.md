...
- **{{CAMPANHA_PADRAO_OURO}}** é o padrão-ouro da conta: {{KPI_MESTRE}} **R$ {{VALOR_PADRAO}}**, criativo campeão **{{AD_CAMPEAO}}**. Toda otimização busca replicar este padrão. (É a base do cálculo de desperdício em `action-prioritization.md`.)

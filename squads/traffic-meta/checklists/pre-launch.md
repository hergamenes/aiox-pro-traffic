# Checklist Pré-Lançamento de Campanha

## Instruções
Todos os itens devem ser PASS para autorizar o lançamento.
Se qualquer item for FAIL → BLOQUEAR lançamento e listar correções.
...
- [ ] utm_source preenchido corretamente
- [ ] utm_medium preenchido corretamente
- [ ] utm_campaign preenchido corretamente
- [ ] utm_content diferenciado por anúncio
- [ ] Pixel/tag de conversão instalado na landing page
...
## 7. Tracking
- [ ] Pixel do Facebook instalado e disparando
- [ ] Eventos de conversão configurados (Purchase, Lead, etc.)
- [ ] Google Analytics recebendo dados (se aplicável)
- [ ] Teste de evento realizado com sucesso
...
**Decisão:** [ ] APROVADO para lançamento / [ ] BLOQUEADO — correções necessárias

**Itens FAIL (se houver):**
1.
2.
3.

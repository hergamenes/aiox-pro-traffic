...
- `reports/{cliente}-google-{accountId}/client-profile.md`
...
| Arquivo | Papel |
|---------|-------|
| `_TEMPLATE.md` | **Único** arquivo permitido aqui. Modelo genérico (só `{{placeholders}}`) para gerar novos perfis. Ancore números por nicho em `../industry-benchmarks.md`. |
...
2. Preencha os `{{placeholders}}` com os dados reais da conta (ancore as faixas em `../industry-benchmarks.md`).
